      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-section">
            ...
            <span className="footer-link" onClick={()=>handleCategoryLink("Telefon")}
              >Telefon</span>
            <span className="footer-link"onClick={()=>handleCategoryLink("Aksesuar")}
              >Aksesuar</span>
            <span className="footer-link"onClick={()=>handleCategoryLink("Bilgisayar")}
              >Bilgisayar</span>
          </div>
          <div className="footer-section">
          ...
          <div className="footer-bottom">
            <p>@2026 Aslınur Gündüzalp - Tüm Hakları Saklıdır.</p>
          </div>
        </div>
      </footer>
    </>

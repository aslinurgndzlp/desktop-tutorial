    ...
    AY: [
      {
        ...
        sender: "AY",
        content:
          "Merhabalar Aslınur hanım, bugün toplantımız Saat 15.00 da olacaktır. Hatırlatmak istedim.",
        time: "10.30",
      },
      {
        id: 2,
...
const messageSlice=createSlice({
    ...
    reducers:{
        sendMessage:(state,action)=>{
            ...
            const nextId=state.threads[activeId].length>0 ? Math.max(...state.threads[activeId].map((m)=>m.id)) +1
            :1;

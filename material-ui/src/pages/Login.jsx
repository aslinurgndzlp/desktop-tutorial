...
export const Login = ({ onLogin }) => {
  ...
  useEffect(() => {
    // Initialize mock users if not existing
    ...
    // Check if remember_username is set
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] p-4">
      <div className="w-full max-w-md p-8 glass rounded-2xl border border-gray-200/50 dark:border-darkBg-border/50 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-6 p-3 rounded-xl bg-primary/5 text-center text-xs text-gray-500 dark:text-gray-400">
            <span className="font-semibold text-primary">Mock Bilgiler:</span> admin / password
          </div>
        </div>
      </div>
    </div>

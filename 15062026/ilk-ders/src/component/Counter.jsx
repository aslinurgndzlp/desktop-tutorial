            ...
            <div className="card p-4">
                ...
                <div className="mt-6">
                    ...
                    <ul className="list-disc">
                        ...
                        <li>State içindeki sayi=sayi+1 şeklinde değiştirilemez.UseState bir fonksiyon ister set ile başlayan bu state içindeki değerini
                            güncellemek vb.işlemleri yapmak için kullanılır.</li>

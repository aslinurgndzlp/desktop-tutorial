...
const Toggle=()=>{
    ...
    return(
        <div className="p-4">
            ...
            <div className = {`demo-card demo-cart-lg demo-toggle-card ${geceModu ? "demo-card-dark":" "}`}>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            <input type={sifreGoster ? "text" : "password"} value={girisSifre} onChange={(e)=>setGirisSifre(e.target.value)} className={geceModu ?
                                "demo-input demo-input-dark pr-20" : "demo-input pr-20"}/>
